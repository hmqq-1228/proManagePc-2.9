         ...
         <div class="sku-list">
           ...
           <div class="right" v-show="item.isEdit">
             <div class="leftName">
               ...
               <i-input placeholder="请输入" style="width: 140px" v-model="item.yearDigital" type="number" @on-enter="submit(item.yearDigital, 'yearDigital', item, index)">
             ...
             <div class="leftName">
               <i>*</i>&nbsp;&nbsp;<span>零售价</span>：
               <i-input placeholder="请输入" style="width: 140px" v-model="item.retailPrice" type="number" @on-enter="submit(item.retailPrice, 'retailPrice', item)">
             ...
             <div class="leftName">
               <i>*</i>&nbsp;&nbsp;<span>吊牌价</span>：
               <i-input placeholder="请输入" style="width: 140px" v-model="item.tagPrice" type="number" @on-enter="submit(item.tagPrice, 'tagPrice', item)">
             ...
             <div class="leftName">
               <i>*</i>&nbsp;&nbsp;<span>固定成本</span>：
               <i-input placeholder="请输入" style="width: 140px" v-model="item.costPrice" type="number" @on-enter="submit(item.costPrice, 'costPrice', item)">
         ...
         <div class="sku-detail" v-show="item.show">
           ...
           <div class="detail-left" v-if="item.isEdit">
             ...
             <div class="sku-info"><span style="margin-right: -0.2em;letter-spacing:0.2em">高（cm）</span>：
               <i-input placeholder="请输入" style="width: 140px" v-model="item.hight" v-if="item.isEdit" type="number" @on-enter="submit(item.hight, 'hight', item)">
             ...
             <div class="sku-info"><span style="margin-right: -0.2em;letter-spacing:0.2em">长（cm）</span>：
               <i-input placeholder="请输入" style="width: 140px" v-model="item.length" v-if="item.isEdit" type="number" @on-enter="submit(item.length, 'length', item)">
             ...
             <div class="sku-info"><span>宽（cm）</span>：
               <i-input placeholder="请输入" style="width: 140px" v-model="item.width" v-if="item.isEdit" type="number" @on-enter="submit(item.width, 'width', item)">
